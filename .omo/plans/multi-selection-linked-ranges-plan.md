...
- [ ] 5. Capture same-container and cross-container linked selections as one item
...
- [ ] 6. Upgrade selection, popover, hit testing, deletion, and handle behavior for linked items
